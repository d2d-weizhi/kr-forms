...
export const termsValidator = (value: string) => (value ? '' : "It's required to agree with the Terms and Conditions.");
...
export const userNameValidator = (value: string) => !value
	...
	: value.length < 5
		? 'Username shoudl be at least 5 characters long.'
		: '';
...
export const guestsValidator = (value: number) => !value
...
export const passwordValidator = (value: string) => value && value.length > 8
	? ''
	: 'Password must be at least 8 alphanumeric characters & symbols.';

export const addressValidator = (value: string) => value 
	? ''
	: 'Address is required.';
